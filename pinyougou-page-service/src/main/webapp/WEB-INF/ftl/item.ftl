		...
		<div id="item">
			...
			<div class="product-info">
				...
				<div class="fr itemInfo-wrap">
					...
					<div class="news"><span>${item.sellPoint!goods.caption}</span></div>
					<div class="summary">
...
购热销商品</em>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<#list goodsDesc.specificationItems?eval as spec>
							<dl>
								<dt>
									<div class="fl title">
								...
								<dd>
									<a href="javascript:;" class="{{isSelected('${spec.attributeName}','${option}')?'selected':''}}"
															ng-click="updateSpec('${spec.attributeName}','${option}')">
										${option}<span title="点击取消选择">&nbsp;</span></a>
								</dd>
								</#list>
							</dl>
							</#list>
